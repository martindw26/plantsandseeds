...
$banner_dt_11 = get_field('banner_desktop_11', 'option');

// Check if the banner field exists
if ($banner_dt_11) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_11['start_date11']);
  $end_date = strtotime($banner_dt_11['end_date11']);
  $campaign_name = $banner_dt_11['campaign_name11'];
  $delivering = $banner_dt_11['delivering11'];
  $CategoryTarget = $banner_dt_11['category11'];
  $PostIDTarget = $banner_dt_11['postid11'];
  $OrderNum = $banner_dt_11['campaign_order_id11'];
  $Image = $banner_dt_11['image11'];
  $Url = $banner_dt_11['url11'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_11['banner_dt_script_11']) {
      echo $banner_dt_11['banner_dt_script_11'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_dt_12 = get_field('banner_desktop_12', 'option');

// Check if the banner field exists
if ($banner_dt_12) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_12['start_date12']);
  $end_date = strtotime($banner_dt_12['end_date12']);
  $campaign_name = $banner_dt_12['campaign_name12'];
  $delivering = $banner_dt_12['delivering12'];
  $CategoryTarget = $banner_dt_12['category12'];
  $PostIDTarget = $banner_dt_12['postid12'];
  $OrderNum = $banner_dt_12['campaign_order_id12'];
  $Image = $banner_dt_12['image12'];
  $Url = $banner_dt_12['url12'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_12['banner_dt_script_12']) {
      echo $banner_dt_12['banner_dt_script_12'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_dt_13 = get_field('banner_desktop_13', 'option');

// Check if the banner field exists
if ($banner_dt_13) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_13['start_date13']);
  $end_date = strtotime($banner_dt_13['end_date13']);
  $campaign_name = $banner_dt_13['campaign_name13'];
  $delivering = $banner_dt_13['delivering13'];
  $CategoryTarget = $banner_dt_13['category13'];
  $PostIDTarget = $banner_dt_13['postid13'];
  $OrderNum = $banner_dt_13['campaign_order_id13'];
  $Image = $banner_dt_13['image13'];
  $Url = $banner_dt_13['url13'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_13['banner_dt_script_13']) {
      echo $banner_dt_13['banner_dt_script_13'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_dt_14 = get_field('banner_desktop_14', 'option');

// Check if the banner field exists
if ($banner_dt_14) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_14['start_date14']);
  $end_date = strtotime($banner_dt_14['end_date14']);
  $campaign_name = $banner_dt_14['campaign_name14'];
  $delivering = $banner_dt_14['delivering14'];
  $CategoryTarget = $banner_dt_14['category14'];
  $PostIDTarget = $banner_dt_14['postid14'];
  $OrderNum = $banner_dt_14['campaign_order_id14'];
  $Image = $banner_dt_14['image14'];
  $Url = $banner_dt_14['url14'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_14['banner_dt_script_14']) {
      echo $banner_dt_14['banner_dt_script_14'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_dt_15 = get_field('banner_desktop_15', 'option');

// Check if the banner field exists
if ($banner_dt_15) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_15['start_date15']);
  $end_date = strtotime($banner_dt_15['end_date15']);
  $campaign_name = $banner_dt_15['campaign_name15'];
  $delivering = $banner_dt_15['delivering15'];
  $CategoryTarget = $banner_dt_15['category15'];
  $PostIDTarget = $banner_dt_15['postid15'];
  $OrderNum = $banner_dt_15['campaign_order_id15'];
  $Image = $banner_dt_15['image15'];
  $Url = $banner_dt_15['url15'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_15['banner_dt_script_15']) {
      echo $banner_dt_15['banner_dt_script_15'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_dt_16 = get_field('banner_desktop_16', 'option');

// Check if the banner field exists
if ($banner_dt_16) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_16['start_date16']);
  $end_date = strtotime($banner_dt_16['end_date16']);
  $campaign_name = $banner_dt_16['campaign_name16'];
  $delivering = $banner_dt_16['delivering16'];
  $CategoryTarget = $banner_dt_16['category16'];
  $PostIDTarget = $banner_dt_16['postid16'];
  $OrderNum = $banner_dt_16['campaign_order_id16'];
  $Image = $banner_dt_16['image16'];
  $Url = $banner_dt_16['url16'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_16['banner_dt_script_16']) {
      echo $banner_dt_16['banner_dt_script_16'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_dt_17 = get_field('banner_desktop_17', 'option');

// Check if the banner field exists
if ($banner_dt_17) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_17['start_date17']);
  $end_date = strtotime($banner_dt_17['end_date17']);
  $campaign_name = $banner_dt_17['campaign_name17'];
  $delivering = $banner_dt_17['delivering17'];
  $CategoryTarget = $banner_dt_17['category17'];
  $PostIDTarget = $banner_dt_17['postid17'];
  $OrderNum = $banner_dt_17['campaign_order_id17'];
  $Image = $banner_dt_17['image17'];
  $Url = $banner_dt_17['url17'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_17['banner_dt_script_17']) {
      echo $banner_dt_17['banner_dt_script_17'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_dt_18 = get_field('banner_desktop_18', 'option');

// Check if the banner field exists
if ($banner_dt_18) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_18['start_date18']);
  $end_date = strtotime($banner_dt_18['end_date18']);
  $campaign_name = $banner_dt_18['campaign_name18'];
  $delivering = $banner_dt_18['delivering18'];
  $CategoryTarget = $banner_dt_18['category18'];
  $PostIDTarget = $banner_dt_18['postid18'];
  $OrderNum = $banner_dt_18['campaign_order_id18'];
  $Image = $banner_dt_18['image18'];
  $Url = $banner_dt_18['url18'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_18['banner_dt_script_18']) {
      echo $banner_dt_18['banner_dt_script_18'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_dt_19 = get_field('banner_desktop_19', 'option');

// Check if the banner field exists
if ($banner_dt_19) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_19['start_date19']);
  $end_date = strtotime($banner_dt_19['end_date19']);
  $campaign_name = $banner_dt_19['campaign_name19'];
  $delivering = $banner_dt_19['delivering19'];
  $CategoryTarget = $banner_dt_19['category19'];
  $PostIDTarget = $banner_dt_19['postid19'];
  $OrderNum = $banner_dt_19['campaign_order_id19'];
  $Image = $banner_dt_19['image19'];
  $Url = $banner_dt_19['url19'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_19['banner_dt_script_19']) {
      echo $banner_dt_19['banner_dt_script_19'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_dt_20 = get_field('banner_desktop_20', 'option');

// Check if the banner field exists
if ($banner_dt_20) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_dt_20['start_date20']);
  $end_date = strtotime($banner_dt_20['end_date20']);
  $campaign_name = $banner_dt_20['campaign_name20'];
  $delivering = $banner_dt_20['delivering20'];
  $CategoryTarget = $banner_dt_20['category20'];
  $PostIDTarget = $banner_dt_20['postid20'];
  $OrderNum = $banner_dt_20['campaign_order_id20'];
  $Image = $banner_dt_20['image20'];
  $Url = $banner_dt_20['url20'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_dt_20['banner_dt_script_20']) {
      echo $banner_dt_20['banner_dt_script_20'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
  ...
  if ($banner_mobile_top_1) {
    ...
    // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
     if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
      ...
      // If the banner has a script, display it
      if ($banner_mobile_top_1['banner_mobile_top_script_1']) {
        echo $banner_mobile_top_1['banner_mobile_top_script_1'];
      } else {
        // Otherwise, display the banner image
        echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
      }
...
$banner_mobile_top_2 = get_field('banner_mobile_2', 'option');
...
if ($banner_mobile_top_2) {
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_2['banner_mobile_top_script_2']) {
      echo $banner_mobile_top_2['banner_mobile_top_script_2'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_3 = get_field('banner_mobile_3', 'option');
...
if ($banner_mobile_top_3) {
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_3['banner_mobile_top_script_3']) {
      echo $banner_mobile_top_3['banner_mobile_top_script_3'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_4 = get_field('banner_mobile_4', 'option');
...
if ($banner_mobile_top_4) {
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_4['banner_mobile_top_script_4']) {
      echo $banner_mobile_top_4['banner_mobile_top_script_4'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_5 = get_field('banner_mobile_5', 'option');
...
if ($banner_mobile_top_5) {
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_5['banner_mobile_top_script_5']) {
      echo $banner_mobile_top_5['banner_mobile_top_script_5'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_6 = get_field('banner_mobile_6', 'option');
...
if ($banner_mobile_top_6) {
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_6['banner_mobile_top_script_6']) {
      echo $banner_mobile_top_6['banner_mobile_top_script_6'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_7 = get_field('banner_mobile_7', 'option');
...
if ($banner_mobile_top_7) {
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_7['banner_mobile_top_script_7']) {
      echo $banner_mobile_top_7['banner_mobile_top_script_7'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_8 = get_field('banner_mobile_8', 'option');
...
if ($banner_mobile_top_8) {
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_8['banner_mobile_top_script_8']) {
      echo $banner_mobile_top_8['banner_mobile_top_script_8'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_9 = get_field('banner_mobile_9', 'option');
...
if ($banner_mobile_top_9) {
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_9['banner_mobile_top_script_9']) {
      echo $banner_mobile_top_9['banner_mobile_top_script_9'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_10 = get_field('banner_mobile_10', 'option');
...
if ($banner_mobile_top_10) {
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_10['banner_mobile_top_script_10']) {
      echo $banner_mobile_top_10['banner_mobile_top_script_10'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_11 = get_field('banner_mobile_11', 'option');

// Check if the banner field exists
if ($banner_mobile_top_11) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_11['start_date11']);
  $end_date = strtotime($banner_mobile_top_11['end_date11']);
  $campaign_name = $banner_mobile_top_11['campaign_name11'];
  $delivering = $banner_mobile_top_11['delivering11'];
  $CategoryTarget = $banner_mobile_top_11['category11'];
  $PostIDTarget = $banner_mobile_top_11['postid11'];
  $OrderNum = $banner_mobile_top_11['campaign_order_id11'];
  $Image = $banner_mobile_top_11['image11'];
  $Url = $banner_mobile_top_11['url11'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_11['banner_mobile_top_script_11']) {
      echo $banner_mobile_top_11['banner_mobile_top_script_11'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_12 = get_field('banner_mobile_12', 'option');

// Check if the banner field exists
if ($banner_mobile_top_12) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_12['start_date12']);
  $end_date = strtotime($banner_mobile_top_12['end_date12']);
  $campaign_name = $banner_mobile_top_12['campaign_name12'];
  $delivering = $banner_mobile_top_12['delivering12'];
  $CategoryTarget = $banner_mobile_top_12['category12'];
  $PostIDTarget = $banner_mobile_top_12['postid12'];
  $OrderNum = $banner_mobile_top_12['campaign_order_id12'];
  $Image = $banner_mobile_top_12['image12'];
  $Url = $banner_mobile_top_12['url12'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_12['banner_mobile_top_script_12']) {
      echo $banner_mobile_top_12['banner_mobile_top_script_12'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_13 = get_field('banner_mobile_13', 'option');

// Check if the banner field exists
if ($banner_mobile_top_13) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_13['start_date13']);
  $end_date = strtotime($banner_mobile_top_13['end_date13']);
  $campaign_name = $banner_mobile_top_13['campaign_name13'];
  $delivering = $banner_mobile_top_13['delivering13'];
  $CategoryTarget = $banner_mobile_top_13['category13'];
  $PostIDTarget = $banner_mobile_top_13['postid13'];
  $OrderNum = $banner_mobile_top_13['campaign_order_id13'];
  $Image = $banner_mobile_top_13['image13'];
  $Url = $banner_mobile_top_13['url13'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_13['banner_mobile_top_script_13']) {
      echo $banner_mobile_top_13['banner_mobile_top_script_13'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_14 = get_field('banner_mobile_14', 'option');

// Check if the banner field exists
if ($banner_mobile_top_14) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_14['start_date14']);
  $end_date = strtotime($banner_mobile_top_14['end_date14']);
  $campaign_name = $banner_mobile_top_14['campaign_name14'];
  $delivering = $banner_mobile_top_14['delivering14'];
  $CategoryTarget = $banner_mobile_top_14['category14'];
  $PostIDTarget = $banner_mobile_top_14['postid14'];
  $OrderNum = $banner_mobile_top_14['campaign_order_id14'];
  $Image = $banner_mobile_top_14['image14'];
  $Url = $banner_mobile_top_14['url14'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_14['banner_mobile_top_script_14']) {
      echo $banner_mobile_top_14['banner_mobile_top_script_14'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_15 = get_field('banner_mobile_15', 'option');

// Check if the banner field exists
if ($banner_mobile_top_15) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_15['start_date15']);
  $end_date = strtotime($banner_mobile_top_15['end_date15']);
  $campaign_name = $banner_mobile_top_15['campaign_name15'];
  $delivering = $banner_mobile_top_15['delivering15'];
  $CategoryTarget = $banner_mobile_top_15['category15'];
  $PostIDTarget = $banner_mobile_top_15['postid15'];
  $OrderNum = $banner_mobile_top_15['campaign_order_id15'];
  $Image = $banner_mobile_top_15['image15'];
  $Url = $banner_mobile_top_15['url15'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_15['banner_mobile_top_script_15']) {
      echo $banner_mobile_top_15['banner_mobile_top_script_15'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_16 = get_field('banner_mobile_16', 'option');

// Check if the banner field exists
if ($banner_mobile_top_16) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_16['start_date16']);
  $end_date = strtotime($banner_mobile_top_16['end_date16']);
  $campaign_name = $banner_mobile_top_16['campaign_name16'];
  $delivering = $banner_mobile_top_16['delivering16'];
  $CategoryTarget = $banner_mobile_top_16['category16'];
  $PostIDTarget = $banner_mobile_top_16['postid16'];
  $OrderNum = $banner_mobile_top_16['campaign_order_id16'];
  $Image = $banner_mobile_top_16['image16'];
  $Url = $banner_mobile_top_16['url16'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_16['banner_mobile_top_script_16']) {
      echo $banner_mobile_top_16['banner_mobile_top_script_16'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_17 = get_field('banner_mobile_17', 'option');

// Check if the banner field exists
if ($banner_mobile_top_17) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_17['start_date17']);
  $end_date = strtotime($banner_mobile_top_17['end_date17']);
  $campaign_name = $banner_mobile_top_17['campaign_name17'];
  $delivering = $banner_mobile_top_17['delivering17'];
  $CategoryTarget = $banner_mobile_top_17['category17'];
  $PostIDTarget = $banner_mobile_top_17['postid17'];
  $OrderNum = $banner_mobile_top_17['campaign_order_id17'];
  $Image = $banner_mobile_top_17['image17'];
  $Url = $banner_mobile_top_17['url17'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_17['banner_mobile_top_script_17']) {
      echo $banner_mobile_top_17['banner_mobile_top_script_17'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_18 = get_field('banner_mobile_18', 'option');

// Check if the banner field exists
if ($banner_mobile_top_18) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_18['start_date18']);
  $end_date = strtotime($banner_mobile_top_18['end_date18']);
  $campaign_name = $banner_mobile_top_18['campaign_name18'];
  $delivering = $banner_mobile_top_18['delivering18'];
  $CategoryTarget = $banner_mobile_top_18['category18'];
  $PostIDTarget = $banner_mobile_top_18['postid18'];
  $OrderNum = $banner_mobile_top_18['campaign_order_id18'];
  $Image = $banner_mobile_top_18['image18'];
  $Url = $banner_mobile_top_18['url18'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_18['banner_mobile_top_script_18']) {
      echo $banner_mobile_top_18['banner_mobile_top_script_18'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_19 = get_field('banner_mobile_19', 'option');

// Check if the banner field exists
if ($banner_mobile_top_19) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_19['start_date19']);
  $end_date = strtotime($banner_mobile_top_19['end_date19']);
  $campaign_name = $banner_mobile_top_19['campaign_name19'];
  $delivering = $banner_mobile_top_19['delivering19'];
  $CategoryTarget = $banner_mobile_top_19['category19'];
  $PostIDTarget = $banner_mobile_top_19['postid19'];
  $OrderNum = $banner_mobile_top_19['campaign_order_id19'];
  $Image = $banner_mobile_top_19['image19'];
  $Url = $banner_mobile_top_19['url19'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_19['banner_mobile_top_script_19']) {
      echo $banner_mobile_top_19['banner_mobile_top_script_19'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
...
$banner_mobile_top_20 = get_field('banner_mobile_20', 'option');

// Check if the banner field exists
if ($banner_mobile_top_20) {

  // Extract the start and end dates, campaign name, delivering status, category target, post ID target, and order number from the banner field
  $start_date = strtotime($banner_mobile_top_20['start_date20']);
  $end_date = strtotime($banner_mobile_top_20['end_date20']);
  $campaign_name = $banner_mobile_top_20['campaign_name20'];
  $delivering = $banner_mobile_top_20['delivering20'];
  $CategoryTarget = $banner_mobile_top_20['category20'];
  $PostIDTarget = $banner_mobile_top_20['postid20'];
  $OrderNum = $banner_mobile_top_20['campaign_order_id20'];
  $Image = $banner_mobile_top_20['image20'];
  $Url = $banner_mobile_top_20['url20'];
  ...
  // Check if the banner is being delivered, the current date is between the start and end dates, and if the category or post ID matches the target
   if ($delivering == 'yes' && $current_date >= $start_date && $current_date <= $end_date) {
    ...
    // If the banner has a script, display it
    if ($banner_mobile_top_20['banner_mobile_top_script_20']) {
      echo $banner_mobile_top_20['banner_mobile_top_script_20'];
    } else {
      // Otherwise, display the banner image
      echo '<a href="' . $Url . '" target="_blank"><img src="' . $Image . '" alt="' . $campaign_name .'"></a>';
    }
