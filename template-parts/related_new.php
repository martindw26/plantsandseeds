...
if (!$relatedPosts->have_posts() && $related_post_override == 'yes') {
    // No related posts found and override is set to yes
    // Fetch posts based on the current post's category
...
?>
    ...
    // You can display a message here if no related posts are found
