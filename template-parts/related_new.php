...
// Check if 'show_related_posts' field is set to 'yes'
if(get_field('show_related_posts', 'option') === 'yes') { 
    ...
    if ($tags) {
        ...
        if($relatedPosts->have_posts()) :
            while($relatedPosts->have_posts()) : $relatedPosts->the_post(); ?>
                ...
                <div class="container p-2 bg-dark text-white">
                    <div class="row">
                        <div class="col-lg-9"><h5><a class="text-decoration-none link-dark text-white" href='<?php the_permalink(); ?>'><?php the_title(); ?></a></h5></div>
            ...
            // If no related posts by tag, check related posts by post ID
        ...
        endif; // end of the else statement from the first block
