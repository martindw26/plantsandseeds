...
if ($navbar_background_color) {
    ...
    echo '<nav class="navbar_background navbar-fluid navbar-expand-md pt-1 nav-link" ' . $style . '" role="navigation">';
} else {
    echo '<nav class="navbar_background navbar-fluid navbar-expand-md pt-1 nav-link" role="navigation">';
}
?>
