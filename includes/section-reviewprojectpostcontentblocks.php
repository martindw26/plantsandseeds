...
<hr><h4 class="">Here are the parts required for the this <?php echo $PartsProductTitle; ?><i> project</i></h4>
<?php endif; ?>	 
...
<?php if ($PartsProductParagraphImage) : ?>
    <p class="border border-1 p-2"><?php echo $PartsProductParagraphImage; ?></p>
<?php endif; ?>    
